 ...
 *
 * Patch Values:
 *   - AArch64Nop  (0xD503201F) ΓåÆ stored in memory as 1F 20 03 D5
 *   - AArch64Mov0 (0x2A1F03E0) ΓåÆ stored in memory as E0 03 1F 2A
 *
 * Supported Patches (nocntchk + noncasigchk + legacy):
 *   - tbz-based content checks   ΓåÆ replaced with NOP
 *   - bl-based signature checks  ΓåÆ replaced with mov w0, #0 or mov w0, wzr
 */
